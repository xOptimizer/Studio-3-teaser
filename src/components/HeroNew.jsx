...
const HeroNew = () => {
  ...
  useEffect(() => {
    ...
    const animate = () => {
      positionRef.current -= 1.05; // Speed of movement (pixels per frame) - doubled for desktop
  ...
  useEffect(() => {
    ...
    const animate = () => {
      mobilePositionRef.current -= 1.05; // Speed of movement (pixels per frame) - doubled for mobile
